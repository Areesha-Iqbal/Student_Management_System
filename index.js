...
const randonNumber = 10000 + Math.random() * 90000;
let myBalance = 0;
let answer = await inquirer.prompt([
    {
        ...
        validate: function (value) {
            ...
            return chalk.red("⚠️  Please enter your name here!\n(Press the arrow buttons to go again)");
        },
    },
    {
        name: "courses",
...
let paymentType = await inquirer.prompt([
    ...
    //Select the amount
    {
        ...
        validate: function (value) {
            ...
            return chalk.red("⚠️  Plaese enter your payment!\n(Press the arrow buttons to go again)");
        },
    },
]);
...
if (tutionFees === paymentAmount) {
    console.log(chalk.magenta(`Congratulations, you have enrolled in ${answer.courses}😊\n`));
    ...
    console.log(chalk.red("⚠️  An incorrect fee has been paid for the course you have selected\n"));
}
